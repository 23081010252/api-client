    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            --sidebar-w: 240px;
            --radius: 8px;
            --shadow: 0 1px 3px rgba(59, 31, 15, 0.08);
        }
        ...
        .sidebar-brand { display: flex; align-items: center; gap: 10px; padding: 20px; border-bottom: 1px solid rgba(255, 255, 255, .06); }
        
        /* Modifikasi Wadah Logo Agar Flexbox Konsisten dengan Ikon Baru */
        .logo { 
            width: 36px; 
            height: 36px; 
        ...
        .sidebar-brand h1 { font-family: 'Playfair Display', serif; font-size: 15px; font-weight: 700; color: #FAF5EC; }
        .sidebar-brand small { font-size: 11px; color: var(--gray-400); }
        .sidebar-nav { flex: 1; padding: 12px 0; overflow-y: auto; }
        .nav-section { padding: 8px 16px 6px; font-size: 10px; font-weight: 700; color: var(--gray-500); text-transform: uppercase; letter-spacing: .08em; }
        .nav-item { display: flex; align-items: center; gap: 10px; padding: 9px 20px; font-size: 13px; color: #d4d4d8; text-decoration: none; transition: .15s; }
        ...
        .sidebar-user-info .urole { font-size: 11px; color: var(--gray-400); }
        
        .btn-logout { width: 100%; padding: 7px; border: 1px solid rgba(255, 255, 255, .1); border-radius: 6px; background: transparent; color: #d4d4d8; font-size: 13px; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 6px; transition: .15s; font-family: inherit; }
        ...
        .topbar-left h2 { font-family: 'Playfair Display', serif; font-size: 18px; font-weight: 700; color: var(--primary-dark); }
        .topbar-left p { font-size: 12px; color: var(--gray-500); margin-top: 1px; }
        
        .api-badge { display: flex; align-items: center; gap: 6px; background: var(--primary-light); border: 1px solid var(--gray-200); border-radius: 20px; padding: 5px 12px; font-size: 11px; color: var(--primary-dark); font-family: monospace; }
        .api-badge .dot { width: 7px; height: 7px; background: var(--sage); border-radius: 50%; flex-shrink: 0; }
        ...
        .card-header h3 { font-family: 'Playfair Display', serif; font-size: 15px; font-weight: 700; color: var(--primary-dark); }
        ...
        thead th { padding: 10px 14px; text-align: left; font-size: 11px; font-weight: 600; color: var(--primary-dark); text-transform: uppercase; letter-spacing: .04em; background: var(--primary-light); border-bottom: 1px solid var(--gray-200); }
        ...
        .form-label { display: block; font-size: 13px; font-weight: 500; color: var(--primary-dark); margin-bottom: 5px; }
        ...
        .form-control:focus { outline: none; border-color: var(--primary); box-shadow: 0 0 0 3px rgba(107, 63, 42, 0.1); }
        ...
        /* ── Modal ── */
        .modal-overlay { display: none; position: fixed; inset: 0; background: rgba(59, 31, 15, 0.4); z-index: 200; align-items: center; justify-content: center; }
        .modal-overlay.show { display: flex; }
        .modal { background: #fff; border-radius: 10px; padding: 24px; max-width: 420px; width: calc(100% - 32px); box-shadow: 0 20px 60px rgba(59, 31, 15, 0.15); }
        .modal-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px; }
        .modal-title { font-family: 'Playfair Display', serif; font-size: 16px; font-weight: 700; color: var(--primary-dark); }
...
<div class="sidebar">
    <div class="sidebar-brand">
        <div class="logo">
            <span class="material-icons" style="font-size: 22px; color: #FAF5EC;">bakery_dining</span>
        </div>
        <div>
            <h1>Toko Roti</h1>
